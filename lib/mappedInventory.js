...
export = class MappedInventory {
    slots:{
        ...
        container: Array<{slot: number, itemHelper: ItemStackHelper}>,
    ...
    addArmor(item: {slot: number, itemHelper: ItemStackHelper}, slot: string): void
    ...
    addContainer(item: {slot: number, itemHelper: ItemStackHelper}): void;
}
